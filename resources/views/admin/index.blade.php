...
<head>
  ...
  <title>ClearVision | Administración EPS</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset('img/logo-mini.png')}}" alt="C|V"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{asset('img/logo-normal.png')}}" alt="Clear|Vision"></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Kristian Orozco</span>
            </a>
            <ul class="dropdown-menu">
...
<div class="row">
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Software de control para opticas.
    </div>
    <!-- Default to the left -->
